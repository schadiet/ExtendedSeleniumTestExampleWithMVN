...
public class TestGasMileAgeCalculationStandardChrome {
	...
	public TestGasMileAgeCalculationStandardChrome(String testName, String browsername, String browserdriver,
...
//		System.out.println(result);
	...
	public static Collection<Object[]> provideTestData() throws Exception {
		...
		Object[][] daten = {
				{ "Gas Mileage Calculator Test - Chrome", "chromebrowser", "chromedriver", "1500", "1000", "50", "1.40",
						"10 km/L or 10 L/100 km" },
				{ "Gas Mileage Calculator Test - Chrome", "chromebrowser", "chromedriver", "1500", "1000", "50", "1.40",
						"10 km/L or 10 L/100 km" } };
